...
public class CompraForm {
	...
	public Object[][] fetchData() {
        ...
        // MOCK DATA
        Endereco end = new Endereco("Jacinto Favoreto", "625", "Apto. 31", "Jardim Luftalla", "123132112", "S�o Carlos",
                "SP");
        Produtor produtor = new Produtor(1, "Gabriel", "06712148", "61991436969", end, "gabriel@gmail.com", "123456",
                "1231231", 1, "De S�o Carlos, s�");
        Produto produto1 = new Produto(3, produtor, "Ma�a GOSTOSA", "Ma�a com gosto bom", 12.0, 5.99, 'k', "Ma�a, amor",
                true);
